package TopDown.Levels
{
   ...
   public class BaseTopDownLevel extends Sprite
   {
      ...
      protected function AddObject(param1:String, param2:int = 0, param3:int = 0, param4:Number = 1, param5:Number = 1, param6:Number = 0) : Object
      {
         ...
         {
            _loc7_ = this.AddExpertRoomTransitionCollObject("roomTransitionObject",param2,param3,param4,param5,param6);
            _loc8_ = _loc7_ as RoomTransitionObject;
            _loc8_.m_transitionID = SpecialRoom.EXPERT_ROOM;
         }
         ...
         else if(param1.slice(0,28) == "telport_roomTransitionObject")
         {
            ...
            {
               _loc8_ = _loc7_ as RoomTransitionObject;
               _loc8_.m_isTeleportTransitionObject = true;
         ...
         else if(param1.slice(0,20) == "roomTransitionObject")
         {
            ...
            {
               _loc8_ = _loc7_ as RoomTransitionObject;
               _loc8_.m_transitionID = int(param1.slice(20));
            }
         }
         ...
         else if(param1 == "expert_entryObject")
         {
            ...
            _loc9_.m_roomComingFrom = SpecialRoom.EXPERT_ROOM;
         }
         else if(param1 == "entryObject_lobbyFromEggery")
         {
            _loc7_ = this.AddRoomTransitionGoToPointObject("entryObject",param2,param3,param4,param5,param6);
            _loc9_ = _loc7_ as RoomTransitionEntryPointObject;
            _loc9_.m_roomComingFrom = SpecialRoom.LOBBY_START;
         }
         ...
         else if(param1.slice(0,11) == "entryObject")
         {
            ...
            {
               _loc9_ = _loc7_ as RoomTransitionEntryPointObject;
               _loc9_.m_roomComingFrom = int(param1.slice(11));
            }
            if(param1.length > 13)
            {
               _loc10_ = param1.slice(13);
               if(_loc10_ == "left")
               {
         ...
         {
            _loc11_ = this.AddChatBox("menus_speechBubble",param2,param3,param4,param5,param6);
            _loc11_.m_chatBoxID = int(param1.slice(18));
         }
      ...
      {
         var _loc7_:WallCollObject = new WallCollObject();
      ...
      {
         var _loc7_:EggeryExitBlockade = new EggeryExitBlockade();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
         this.m_wallCollObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      }
      ...
      {
         var _loc7_:CourtyardExitBlockade = new CourtyardExitBlockade();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
         this.m_wallCollObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      }
      
      protected function AddElevatorWallCollObject(param1:String, param2:int, param3:int, param4:Number, param5:Number, param6:Number, param7:String = "vanilla") : void //param7 is the elevator ID: "vanilla" or "icefloor"
      {
      ...
      {
         var _loc7_:WallCollObject = new WallCollObject();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_wallCollObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      }
      ...
      {
         var _loc7_:RegularKeyDoor = new RegularKeyDoor();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
      ...
      {
         var _loc7_:BossToEggeryDoorWall = new BossToEggeryDoorWall();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
         _loc7_.m_interationID = 2;
         this.m_wallCollObjects.push(_loc7_);
         this.m_interactionObjects.push(_loc7_);
      ...
      {
         var _loc8_:VisualLevelObjectWithHeight = new VisualLevelObjectWithHeight();
         _loc8_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
      ...
      {
         var _loc7_:RoomTransitionObject = new RoomTransitionObject();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
      ...
      {
         var _loc7_:ExpertRoomTransitionObject = new ExpertRoomTransitionObject();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
      ...
      {
         var _loc8_:ButtonZone = new ButtonZone();
         _loc8_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
      ...
      {
         var _loc8_:GoldChest = new GoldChest();
         ...
         this.m_collObjects.push(_loc8_);
         this.m_allObjects.push(_loc8_);
         var _loc9_:GoldChestTopLayer = new GoldChestTopLayer();
         _loc9_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
      ...
      {
         var _loc8_:GemChest = new GemChest();
         _loc8_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         _loc8_.m_arraySpotOfTopObject = this.m_allObjects.length + 1;
         this.m_collObjects.push(_loc8_);
         this.m_allObjects.push(_loc8_);
         var _loc9_:GemChestTopLayer = new GemChestTopLayer();
         _loc9_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
         _loc9_.m_activationHieghtPoint = 8;
         _loc9_.m_arraySpotOfBottomObject = this.m_allObjects.length - 1;
         this.m_visualObjectWithHeight.push(_loc9_);
      ...
      {
         var _loc7_:RoomTransitionEntryPointObject = new RoomTransitionEntryPointObject();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer,false);
      ...
      {
         var _loc7_:HealStone = new HealStone();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_visualObjects.push(_loc7_);
         this.m_interactionObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      ...
      {
         var _loc7_:StandardChatBox = new StandardChatBox();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer,false);
         this.m_visualObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
         return _loc7_;
      }
      ...
      {
         var _loc7_:ExpertRoomVisualObjectBase = new ExpertRoomVisualObjectBase();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_visualObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      }
      ...
      {
         var _loc9_:ExpertRoomVisualObjectGlow = new ExpertRoomVisualObjectGlow(param8);
         _loc9_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_visualObjects.push(_loc9_);
         this.m_allObjects.push(_loc9_);
         var _loc10_:ExpertRoomVisualObjectGlow = new ExpertRoomVisualObjectGlow(param8);
         _loc10_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
      ...
      {
         var _loc9_:VisualsForEgg = new VisualsForEgg();
         _loc9_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         _loc9_.m_eggID = param8;
         this.m_visualObjects.push(_loc9_);
         this.m_allObjects.push(_loc9_);
         var _loc10_:VisualsForEgg = new VisualsForEgg();
         _loc10_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
         _loc10_.m_activationHieghtPoint = param2;
      ...
      {
         var _loc9_:TitanVisualsForEgg = new TitanVisualsForEgg();
         _loc9_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         _loc9_.m_eggID = param8;
         this.m_visualObjects.push(_loc9_);
         this.m_allObjects.push(_loc9_);
         var _loc10_:TitanVisualsForEgg = new TitanVisualsForEgg();
         _loc10_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
         _loc10_.m_activationHieghtPoint = param2;
         _loc10_.m_eggID = param8;
         _loc10_.m_arraySpotOfBottomObject = this.m_allObjects.length - 1;
      ...
      {
         var _loc7_:VisualsForBossDoor = new VisualsForBossDoor();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_visualObjects.push(_loc7_);
         this.m_interactionObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      ...
      {
         var _loc7_:BossToEggeryDoorVisuals = new BossToEggeryDoorVisuals();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_visualObjects.push(_loc7_);
         this.m_interactionObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      ...
      {
         var _loc12_:SoundDistanceObject = new SoundDistanceObject(param7,param8,param9,param10);
         _loc12_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
      ...
      {
         var _loc8_:FireTorch = new FireTorch();
         _loc8_.m_numberOfFrames = param7;
         _loc8_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
      ...
      {
         var _loc7_:VisualLevelObject = new VisualLevelObject();
         _loc7_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
         this.m_visualObjects.push(_loc7_);
         this.m_allObjects.push(_loc7_);
      }
      ...
      {
         var _loc10_:RiverSplashObject = new RiverSplashObject();
         _loc10_.AddSpriteFirstTime(param1,param2,param3,param4,param5,param6,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_bottomVisualLayer);
      ...
      {
         var _loc11_:RiverSplashObject = new RiverSplashObject();
         _loc11_.AddSpriteFirstTime(param1,param3,param4,param5,param6,param7,Singleton.utility.m_screenControllers.m_topDownScreen.m_topDownMovementScreen.m_topVisualLayer);
      ...
      protected function PreformButtonAction(param1:int) : void
      {
         ...
         if(param1 == 0)
         {
            ...
            else
            {
               ...
               _loc4_ = Singleton.dynamicData.GetStarsForCurrentFloorAndRoom();
               if(_loc4_ == 3)
               {
