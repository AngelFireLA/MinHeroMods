package TopDown.Menus
{
   ...
   public class GemCombiner extends TopDown.Menus.BaseLargeGemMenu
   {
      ...
      protected var m_sortButton:TCButton;
      
      protected var m_sortButtonText:TextField;
      ...
      override public function LoadSprites() : void
      {
         ...
         _loc1_.color = 16001835;
         _loc1_.size = 12;
         this.m_needSameTieredGemsText.defaultTextFormat = _loc1_;
         ...
         _loc1_.color = 16001835;
         _loc1_.size = 12;
         this.m_notEnoughMoneyText.defaultTextFormat = _loc1_;
         ...
         _loc1_.color = 15790320;
         _loc1_.size = 18;
         this.m_combinedButtonText.defaultTextFormat = _loc1_;
         ...
         this.m_sortButton = new TCButton(this.SortButtonPressed,"menus_gemCombiner_CombineButton");
         this.m_sortButton.x = 507;
         this.m_sortButton.y = 220;
         m_background.addChild(this.m_sortButton);
         this.m_sortButtonText = new TextField();
         this.m_sortButtonText.embedFonts = true;
         _loc1_.color = 15790320;
         _loc1_.size = 18;
         this.m_sortButtonText.defaultTextFormat = _loc1_;
         this.m_sortButtonText.wordWrap = true;
         this.m_sortButtonText.autoSize = TextFieldAutoSize.CENTER;
         this.m_sortButtonText.text = "Sort Gems";
         this.m_sortButtonText.x = 4;
         this.m_sortButtonText.y = 9;
         this.m_sortButtonText.width = 150;
         this.m_sortButtonText.selectable = false;
         this.m_sortButton.addChild(this.m_sortButtonText);
      ...
      override public function Update() : void
      {
         ...
         this.m_sortButton.m_isActive = true;
      ...
      public function CombineGemsButtonPressed(param1:MouseEvent) : void
      {
         ...
         Singleton.dynamicData.AddToOwnedGemsFromPage(this.m_gems[3],currentPage);
         var _loc2_:int = 0;
      ...
      public function SortButtonPressed(param1:MouseEvent) : void
      {
         Singleton.dynamicData.SortOwnedGems();
         m_gemSelector.UpdateGems_Snap();
         this.UpdateAllTheInterfacePieces();
      }
