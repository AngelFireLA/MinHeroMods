   ...
   public class TrainerSystem
   {
      ...
      public function LoadTrianer(param1:int, param2:int) : TrainerDataObject
      {
         ...
         while(_loc7_ < _loc3_.m_minions.length)
         {
            ...
            _loc5_ = new OwnedMinion(_loc6_.m_minionID,false);
            _loc5_.m_trainerType = _loc3_.m_trainerType;
      ...
      {
         var _loc4_:TrainerDataObject = new TrainerDataObject();
         _loc4_.m_trainerType = param1;
