package TopDown
{
   ...
   public class TopDownMovementScreen
   {
      ...
      private var m_defaultMovementSpeed:Number = 11;
      ...
      public function LoadSprites() : void
      {
         ...
         this.m_mainCharCenterPointX = 318;
         this.m_mainCharCenterPointY = 217.5;
      ...
      public function SetCameraToMainCharPosition(param1:Boolean = true) : void
      {
         ...
         var _loc4_:Point = this.m_currLevel.m_roomBounds.localToGlobal(new Point(this.m_currLevel.m_roomBounds.x,this.m_currLevel.m_roomBounds.y));
         if(_loc4_.y + this.m_mainCharCenterPointY >= this.m_cameraCollRect.y)
         {
         ...
         if(param1)
         {
            _loc5_ = this.m_currLevel.CheckForWallCollisionsWithObject(this.m_mainCharCollBox);
            if(_loc5_ != null)
            {
         ...
         _loc4_ = this.m_currLevel.m_roomBounds.localToGlobal(new Point(this.m_currLevel.m_roomBounds.x,this.m_currLevel.m_roomBounds.y));
         if(_loc4_.x + this.m_mainCharCenterPointX >= this.m_cameraCollRect.x)
         {
      ...
      private function PlayFuseSageSealsTogether() : void
      {
         ...
         _loc7_.append(new TweenLite(this.m_flash,1.3,{}));
         ...
         while(_loc1_ < this.m_sagePiecesForFusion.length)
         {
            ...
            _loc7_.append(new TweenLite(this.m_sagePiecesForFusion[_loc1_],1.3,{}));
         ...
         _loc7_ = new TimelineLite();
         _loc7_.append(new TweenLite(this.m_sageSealFused,1.3,{}));
