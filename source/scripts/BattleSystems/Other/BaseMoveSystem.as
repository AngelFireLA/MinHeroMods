   ...
   public class BaseMoveSystem
   {
      ...
      public function LoadUpTheQueueAndPlayMoves() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            {
               _loc5_ = Singleton.staticData.GetVisualMinionMove(MinionVisualMoveID.VISUALS_MOVE_MISS);
               _loc5_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,this.m_currMove,this.m_currMinion,this.m_enemiesItHits[_loc3_]);
               if(this.m_currMove.m_isThereABufferBetweenVisualMovesOnMultipleEnemies)
               {
                  _loc1_.push(new MoveQueueObject(0.1,this.MoveCurrentMinion));
            ...
            {
               _loc5_ = Singleton.staticData.GetVisualMinionMove(this.m_currMove.m_visualMoveID);
               _loc5_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,this.m_currMove,this.m_currMinion,this.m_enemiesItHits[_loc3_]);
               if(this.m_currMove.m_isThereABufferBetweenVisualMovesOnMultipleEnemies)
               {
                  _loc1_.push(new MoveQueueObject(0.1,this.MoveCurrentMinion));
               ...
               {
                  _loc5_ = Singleton.staticData.GetVisualMinionMove(MinionVisualMoveID.VISUALS_MOVE_STUNNED);
                  _loc5_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,this.m_currMove,this.m_currMinion,this.m_enemiesItHits[_loc3_]);
                  _loc1_.push(new MoveQueueObject(_loc5_.m_moveTime - 0.1,_loc5_.PlayMove));
               }
               if(this.m_currMove.m_freezeChance > this.m_freezeChance)
               {
                  _loc5_ = Singleton.staticData.GetVisualMinionMove(MinionVisualMoveID.VISUALS_MOVE_FROZEN);
                  _loc5_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,this.m_currMove,this.m_currMinion,this.m_enemiesItHits[_loc3_]);
                  _loc1_.push(new MoveQueueObject(_loc5_.m_moveTime - 0.1,_loc5_.PlayMove));
               }
               if(this.m_enemiesItHits[_loc3_].m_currReflectDamagePercentage > 0)
               {
                  _loc5_ = Singleton.staticData.GetVisualMinionMove(MinionVisualMoveID.VISUALS_MOVE_DAMAGE_REFLECTED);
                  _loc5_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,this.m_currMove,this.m_currMinion,this.m_enemiesItHits[_loc3_]);
                  _loc1_.push(new MoveQueueObject(_loc5_.m_moveTime - 0.1,_loc5_.PlayMove));
               }
            }
         ...
         {
            _loc5_ = Singleton.staticData.GetVisualMinionMove(this.m_currMove.m_visualMoveID);
            _loc5_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,this.m_currMove,this.m_currMinion,this.m_alliesItHits[_loc3_]);
            if(this.m_currMove.m_isThereABufferBetweenVisualMovesOnMultipleEnemies)
            {
               _loc1_.push(new MoveQueueObject(0.1,this.MoveCurrentMinion));
               _loc1_.push(new MoveQueueObject(_loc5_.m_moveTime - 0.1,_loc5_.PlayMove));
         ...
         if(this.m_currMove.m_doesBuffSelf)
         {
            ...
            while(_loc6_ < this.m_currMove.m_statTypesToBuff.length)
            {
               ...
               {
                  _loc7_ = BaseStatModifyMove(Singleton.staticData.GetVisualMinionMove(MinionVisualMoveID.VISUALS_STAT_CHANGE));
                  _loc7_.m_isPositiveIncrease = true;
         ...
         if(this.m_currMove.m_doesDeBuffSelf)
         {
            ...
            while(_loc6_ < this.m_currMove.m_statTypesToDeBuff.length)
            {
               ...
               {
                  _loc7_ = BaseStatModifyMove(Singleton.staticData.GetVisualMinionMove(MinionVisualMoveID.VISUALS_STAT_CHANGE));
                  _loc7_.m_isPositiveIncrease = false;
      ...
      private function ApplyEffectsOfCurrentMove() : void
      {
         ...
         while(_loc11_ < this.m_enemiesItHits.length)
         {
            _loc4_ = _loc1_;
            _loc7_ = 1;
            _loc7_ = _loc7_ * Singleton.staticData.CalculateEffectivenessModifier(this.m_currMove.m_moveType,this.m_enemiesItHits[_loc11_].m_baseMinion.m_minionType1);
            _loc7_ = _loc7_ * Singleton.staticData.CalculateEffectivenessModifier(this.m_currMove.m_moveType,this.m_enemiesItHits[_loc11_].m_baseMinion.m_minionType2);
            if(_loc7_ > 1.4)
            {
         ...
         while(_loc11_ < this.m_alliesItHits.length)
         {
            ...
            _loc6_ = _loc3_;
            _loc7_ = 1;
            _loc7_ = _loc7_ * Singleton.staticData.CalculateHealingEffectivenessModifier(this.m_currMove.m_moveType,this.m_alliesItHits[_loc11_].m_baseMinion.m_minionType1);
            _loc7_ = _loc7_ * Singleton.staticData.CalculateHealingEffectivenessModifier(this.m_currMove.m_moveType,this.m_alliesItHits[_loc11_].m_baseMinion.m_minionType2);
            if(_loc7_ > 1.4 && _loc5_ > 0)
            {
