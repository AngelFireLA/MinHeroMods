package BattleSystems.Other
{
   ...
   public class AIMoveSystem extends BaseMoveSystem
   {
      ...
      private function BuildMoveChainThreat(param1:int, param2:Array, param3:Array, param4:AIMovePacket) : void
      {
         ...
         {
            _loc5_ = param2[param1].m_allMovesJustHighestTier_asActualMoves;
            _loc5_.push(Singleton.staticData.GetBaseMinionMove(MinionMoveID.desperation_t1));
            _loc6_ = 0;
      ...
      private function CalculateDamageMoveThreat(param1:BaseMinionMove, param2:OwnedMinion, param3:Array, param4:int, param5:Boolean = true, param6:int = 0, param7:Number = 0) : Number
      {
         ...
         var _loc8_:Number = 0;
         var _loc9_:Number = param1.m_damage;
         _loc9_ = _loc9_ + param1.m_additionalRandomDamage / 2;
         ...
         if(param1.m_DOTDamage > 0 || param1.m_additionalDOTDamage > 0)
         {
            ...
            {
               _loc14_ = param1.m_DOTDamage;
               _loc14_ = _loc14_ + param1.m_additionalDOTDamage / 2;
         ...
         _loc11_ = _loc11_ * Singleton.staticData.CalculateEffectivenessModifier(param1.m_moveType,param3[param4].m_baseMinion.m_minionType1);
         _loc11_ = _loc11_ * Singleton.staticData.CalculateEffectivenessModifier(param1.m_moveType,param3[param4].m_baseMinion.m_minionType2);
         _loc10_ *= _loc11_;
         if(this.m_enemyThreatLevels != null)
         {
         ...
         {
            _loc16_ = param1.m_selfDamage;
            _loc16_ = _loc16_ + param1.m_additionalRandomSelfDamage / 2;
            ...
            _loc11_ = 1;
            _loc11_ = _loc11_ * Singleton.staticData.CalculateEffectivenessModifier(param1.m_moveType,param2.m_baseMinion.m_minionType1);
            _loc11_ = _loc11_ * Singleton.staticData.CalculateEffectivenessModifier(param1.m_moveType,param2.m_baseMinion.m_minionType2);
            _loc17_ *= _loc11_;
         ...
         {
            _loc18_ = param1.m_selfHeal;
            _loc18_ = _loc18_ + param1.m_additionalRandomSelfHeal / 2;
         ...
         {
            _loc8_ -= param1.m_exhaustTime * (_loc8_ * 0.5);
            _loc8_ = _loc8_ - param1.m_exhaustTime * (_loc8_ * 0.66);
         }
         var _loc13_:int = 0;
         ...
         _loc8_ += _loc10_;
         _loc8_ = _loc8_ * (param1.m_accuracy / 100);
         _loc8_ = _loc8_ * param3[param4].m_currArmorModRate;
         if(param5)
         {
      ...
      private function CalculateHealingMoveThreat(param1:BaseMinionMove, param2:OwnedMinion, param3:Array, param4:int, param5:Boolean = true, param6:int = 0, param7:Number = 0) : Number
      {
         ...
         var _loc8_:Number = 0;
         var _loc9_:Number = param1.m_healing;
         _loc9_ = _loc9_ + param1.m_additionalRandomHealing / 2;
         ...
         var _loc11_:Number = 1;
         _loc11_ = _loc11_ * Singleton.staticData.CalculateHealingEffectivenessModifier(param1.m_moveType,param3[param4].m_baseMinion.m_minionType1);
         _loc11_ = _loc11_ * Singleton.staticData.CalculateHealingEffectivenessModifier(param1.m_moveType,param3[param4].m_baseMinion.m_minionType2);
         _loc10_ *= _loc11_;
         ...
         if(param1.m_setShieldAmount > 0)
         {
            ...
            _loc13_ *= _loc11_;
            if(_loc13_ > param3[param4].m_currShield)
            {
         ...
         if(param1.m_HOTHealing > 0 || param1.m_additionalHOTHealing > 0)
         {
            if(!param3[param4].IsHotOrDotActive(param1.m_moveID))
            {
               _loc14_ = param1.m_HOTHealing;
               _loc14_ = _loc14_ + param1.m_additionalHOTHealing / 2;
               ...
               {
                  _loc14_ = param3[param4].m_currHealthStat - param3[param4].m_currHealth;
                  _loc14_ = _loc14_ * 2;
               }
               _loc10_ += _loc14_;
            }
      ...
      private function CalculateBuffValue(param1:int, param2:int, param3:OwnedMinion, param4:Number) : Number
      {
         ...
         {
            _loc5_ = param3.m_currEnergy / param3.m_currEnergyStat;
            return _loc5_ * param4 * (1 - Singleton.staticData.GetStatStageModificationAmount(param2));
         }
         if(param1 == StatType.STAT_HEALTH)
         {
            _loc5_ = param3.m_currHealthStat / 150;
            return _loc5_ * param4 * Singleton.staticData.GetStatStageModificationAmount(param2);
         }
         return 0;
      }
      ...
      private function CalculateTotalTeamThreat(param1:Array, param2:Array, param3:Boolean) : void
      {
         ...
         {
            _loc9_ = param1[_loc8_].m_allMovesJustHighestTier_asActualMoves;
            _loc9_.push(Singleton.staticData.GetBaseMinionMove(MinionMoveID.desperation_t1));
