package Minions
{
   ...
   public class OwnedMinion
   {
      ...
      public var m_gems:Vector.<OwnedGem>;
      ...
      public function TickDotsAndHots() : Number
      {
         ...
         while(_loc7_ > -1)
         {
            ...
            if(_loc3_.m_DOTDamage > 0 || _loc3_.m_additionalDOTDamage > 0)
            {
               ...
               _loc4_ = 1;
               _loc4_ *= Singleton.staticData.CalculateEffectivenessModifier(_loc3_.m_moveType,this.m_baseMinion.m_minionType1);
               _loc4_ = _loc4_ * Singleton.staticData.CalculateEffectivenessModifier(_loc3_.m_moveType,this.m_baseMinion.m_minionType2);
               _loc5_ *= _loc4_;
               _loc2_ -= _loc5_;
               _loc8_ = Singleton.staticData.GetVisualMinionMove(_loc3_.m_visualDOTMoveID);
               _loc8_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,_loc3_,this.m_minionForDOTsAndHOTs[_loc7_],this);
               _loc8_.PlayMove();
            ...
            if(_loc3_.m_HOTHealing > 0 || _loc3_.m_additionalHOTHealing > 0)
            {
               ...
               _loc4_ = 1;
               _loc4_ *= Singleton.staticData.CalculateHealingEffectivenessModifier(_loc3_.m_moveType,this.m_baseMinion.m_minionType1);
               _loc4_ = _loc4_ * Singleton.staticData.CalculateHealingEffectivenessModifier(_loc3_.m_moveType,this.m_baseMinion.m_minionType2);
               _loc6_ *= _loc4_;
               _loc2_ += _loc6_;
               _loc8_ = Singleton.staticData.GetVisualMinionMove(_loc3_.m_visualDOTMoveID);
               _loc8_.CreateMove(Singleton.utility.m_screenControllers.m_battleScreen,_loc3_,this.m_minionForDOTsAndHOTs[_loc7_],this);
      ...
      public function CalculateHealthStat(param1:int) : int
      {
         ...
         var _loc4_:Number = _loc3_ / this.GetHeathStatDivisor(param1) + this.m_baseHealth;
         _loc4_ += this.GetExtraStatFromGem(StatType.STAT_HEALTH);
         _loc4_ = _loc4_ * Singleton.staticData.GetStatStageModificationAmount(this.m_currStatStages[StatType.STAT_HEALTH]);
      ...
      public function CalculateEnergyStat(param1:int) : int
      {
         ...
         var _loc4_:Number = _loc3_ / this.m_statDivisor + this.m_baseHealth;
         _loc4_ += this.GetExtraStatFromGem(StatType.STAT_ENERGY);
         if(this.m_statBonus == StatType.STAT_ENERGY)
         {
            _loc4_ *= 1.05;
         }
         _loc4_ *= Singleton.staticData.GetStatStageModificationAmount(this.m_currStatStages[StatType.STAT_ENERGY]);
      ...
      public function CalculateAttackStat(param1:int) : int
      {
         ...
         var _loc4_:Number = _loc3_ / this.m_statDivisor + this.m_baseStat;
         _loc4_ += this.GetExtraStatFromGem(StatType.STAT_ATTACK);
         if(this.m_statBonus == StatType.STAT_ATTACK)
         {
            _loc4_ *= 1.05;
         }
         _loc4_ *= Singleton.staticData.GetStatStageModificationAmount(this.m_currStatStages[StatType.STAT_ATTACK]);
      ...
      public function CalculateHealingStat(param1:int) : int
      {
         ...
         var _loc4_:Number = _loc3_ / this.m_statDivisor + this.m_baseStat;
         _loc4_ += this.GetExtraStatFromGem(StatType.STAT_HEALING);
         if(this.m_statBonus == StatType.STAT_HEALING)
         {
            _loc4_ *= 1.05;
         }
         _loc4_ *= Singleton.staticData.GetStatStageModificationAmount(this.m_currStatStages[StatType.STAT_HEALING]);
      ...
      public function CalculateSpeedStat(param1:int) : int
      {
         ...
         var _loc4_:Number = _loc3_ / this.m_statDivisor + this.m_baseStat;
         _loc4_ += this.GetExtraStatFromGem(StatType.STAT_SPEED);
         if(this.m_statBonus == StatType.STAT_SPEED)
         {
            _loc4_ *= 1.05;
         }
         _loc4_ *= Singleton.staticData.GetStatStageModificationAmount(this.m_currStatStages[StatType.STAT_SPEED]);
      ...
      public function get m_currExpPercentageToNextLevel() : Number
      {
         ...
         var _loc4_:int = this.m_currentExp - _loc2_;
