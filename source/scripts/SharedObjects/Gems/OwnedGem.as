package SharedObjects.Gems
{
   ...
   public class OwnedGem
   {
      ...
      {
         return 1 + (Math.random() * 95 - 40) / 100;
      }
      ...
      public function GetTooltip() : Sprite
      {
         ...
         var _loc4_:TextField = this.GetTextFieldForGemDescription();
      ...
      public function GetTextFieldForGemDescription() : TextField
      {
         ...
         {
            _loc5_.color = _loc3_[_loc9_];
            _loc6_.setTextFormat(_loc5_,_loc7_,_loc4_[_loc9_] + _loc7_);
      ...
      public function GetMainStatType() : int
      {
         var mainStatType:int = 0;
         var maxStat:Number = 0;
         var i:int = 0;
         while(i < this._rawStats.length)
         {
